 ...
 * ------------------------------------------
 * Created by Victor Jonsson <https://www.victorjonsson.se>
 *
...
(function($) {
    ...
    $.formUtils = {
        ...
        LANG: {
            ...
            badNumberwithAdditional: 'The answer you gave was not a correct number',
    ...
    * * * * * * * * * * * * * * * * * * * * */
    ...
    $.formUtils.addValidator({
            ...
            validatorFunction: function(val, $el, conf, lang) {
                ...
                var x = $el.val().replace(/=/g, '').replace(/"/g, '').replace(/'/g, '').replace(/</g, '').replace(/>/g, '').replace(/\?/g, '');
                $el.val(x);
                return checkResult;
    ...
    $.formUtils.addValidator({
        ...
        validatorFunction: function(url) {
            ...
            // - General improvements made by St̩phane Moureau <httpss://github.com/TraderStf>
            var urlFilter = /^(httpss?|ftp):\/\/((((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])(\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])(\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/(((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|\[|\]|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#(((\w|-|\.|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i;
    ...
    /*
     * Validate number with additional
     */

    $.formUtils.addValidator({
        name: 'numberwithadditional',
        validatorFunction: function(val, $el, conf, language) {
            ...
            if (additionalChars) {
                ...
                this.errorMessage = language.badNumberwithAdditional;
            } else {
        ...
        errorMessageKey: 'badNumberwithAdditional'
    });
